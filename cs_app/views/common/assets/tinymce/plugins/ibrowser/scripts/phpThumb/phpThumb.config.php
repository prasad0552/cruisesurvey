...
//Xaraya config option
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['cache_directory']; //dirname(__FILE__).'/cache/';                            // set the cache directory relative to the phpThumb() installation
