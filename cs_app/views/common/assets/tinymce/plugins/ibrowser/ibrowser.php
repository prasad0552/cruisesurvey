<?php
    ...
    // ================================================
    //Amended for Xarigami and Xaraya by Jo Dalle Nogare
    //Updated for php5.3
    //Last updated 2010-05-25
    // Xarigami IBrowser 3.1.0
    //-------------------------------------------------------------------------
...
// ============================================================
    function init() {           
        ...
        //-------------------------------------------------------------------------
        preloadImages('images/firefox.gif','images/explorer.gif','images/img_in.gif','images/img_at.gif','images/img_po.gif','images/help.gif','images/help_off.gif','images/about.gif','images/about_off.gif','images/ib.gif','images/dir_off.gif','images/dir.gif','images/prev_off.gif','images/prev.gif','images/symbols_off.gif','images/symbols.gif','images/alert_off.gif','images/alert.gif','images/dirview_off.gif','images/dirview.gif'); // preload images              
        btnStage();
