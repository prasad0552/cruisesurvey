...
class Languages extends CI_Controller {
	...
	function editLanguageValue($language_code,$variable_name)
	{
		if(!isAdmin())
			redirect_admin('login');
		...
		if(empty($language_code) && empty($variable_name))
		{
			$this->session->set_flashdata('flash_message', $this->admin_model->flash_message('error','Invalid Language code or variable.'));
			redirect_admin('languages/manageLanguageValues');	
		}	
		...
		$this->outputData['language_value']	= $this->languages_model->getLanguageValue($language_id);
		$this->outputData['main_content'] 	= 'admin/languages/editLanguage';
		$this->load->view('admin/admin_template',$this->outputData);
	}
